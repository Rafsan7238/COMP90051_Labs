...
/data: contains the training and test dataset
/Group Logistics: contains the group agreement and meeting minutes files
/Final Model: contains the final ML models and their outputs as follows:
	/Final Model/LightGBM Model.ipynb: final LGBM model
	/Final Model/SVM.ipynb: final SVM model
	/Final Model/Mixed Model.ipynb: final ensemble model
